package com.leochin.findfriends.push;
 ...
 * @author Mr.Wen <br />
 * @version 1.0 <br />
 * @created 2013-5-15 上午11:19:48 <br />
 * 
 */
public class MQTTService extends Service implements MqttSimpleCallback {
	...
	/*
	 * Add by yanjun.wang
	 * constants used to get serivce add  and  topic form intent
	 */
	public static final String INTENT_KEY_SERVICE_ADD = "IPADD";
	...
	public void onCreate() {
		...
		// SharedPreferences settings = getSharedPreferences(APP_ID,
		// MODE_PRIVATE);
	 ...
	 * @param intent
	 */
	public void onServiceStart(final Intent intent,  final int startId){
	    brokerHostName = intent.getStringExtra(INTENT_KEY_SERVICE_ADD);
	    topicName = intent.getStringExtra(INTENT_KEY_TOPIC);
	    
	    if(topicName == null | brokerHostName == null){
	        stopSelf();
	        return;
	    }
...
//					R.drawable.ic_launcher, "MQTT", System.currentTimeMillis());
